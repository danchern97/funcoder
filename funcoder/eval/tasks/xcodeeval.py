...
from ...methods.funcoder.make_test import TestType
from ...methods.funcoder.prompts.injected import FuncoderInjectedStdioPrompt
...
class xCodeEvalEvalTasks(CodeGenEvalTasks[InputXCE, VerdictXCE]):
    ...
    async def execute(self, ctx, method, task_id, task) -> tuple[EvalResult[InputXCE, VerdictXCE], CodeGenJournal]:
        ...
        FuncoderInjectedStdioPrompt.inject(sample_tests)
