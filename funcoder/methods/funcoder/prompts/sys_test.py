...
class FuncoderSysTestArgsPrompt(MakeTestPrompt):
...
Store extracted cases for `{func_name}(...)` as function calls or assertions, one per line."""
    ...
    get_few_shots = [
        {
            "role": "system",
            "content": """You are a proficient software engineer and architect, specialized in testing. You will perform a series of very accurate tasks in extracting test cases from the user's requirements, and translate them into proper python expressions. Specifically:
